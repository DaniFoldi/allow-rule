...
test('apply single ruleset', () => {
  expect(applyRuleset('single', {})).resolves.toBe('allow')
})

test('apply all ruleset', () => {
  expect(applyRuleset('all', {})).resolves.toBe('deny')
})

test('apply any ruleset', () => {
  expect(applyRuleset('any', {})).resolves.toBe('allow')
})

test('apply none ruleset', () => {
  expect(applyRuleset('none', {})).resolves.toBe('deny')
})